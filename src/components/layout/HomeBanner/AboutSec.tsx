...
function AboutSec() {
  return (
    <div className="aboutUsWrap py-[4.5rem] md:py-[5.5rem] lg:py-[6.5rem] xl:py-[7.5rem] relative w-full">
  <div className="fixedBg bg-left-top bg-no-repeat opacity-20 bg-[url('/images/about-bg.jpg')]"></div>
  <div className="container sm:container md:container lg:container xl:container 2xl:container mx-auto">
    <div className="secTitleWrap flex justify-center text-center w-full mb-[2.1875rem]">
      <div className="secTitle max-w-[100%] md:max-w-[90%] lg:max-w-[55%]">
        <h2 className="text-[#f6371c]2 text-[1.875rem] md:text-[3.125rem] font-Poppins font-bold relative">
          <i className="h-[3.5rem] w-[3.5rem] md:h-[5.625rem] md:w-[5.625rem] rounded-[10px] md:rounded-[1.25rem] absolute ml-[-1.75rem] md:ml-[-2.8125rem] left-1/2 dark:bg-[#000] bg-[#eeeffa] text-black dark:text-white z-[-1] top-[-12%] md:top-[-15%]"></i>About <span className="text-[#f6371c] text-[1.875rem] md:text-[3.125rem] fontCaveat font-bold relative">Me</span>
        </h2>
        <p className="text-desc2 text-[1rem] md:text-[1.25rem] sm:text-[1.225rem] mt-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
      </div>
    </div>
    <div className="aboutUs relative w-full p-[1.25rem] lg:p-[1.875rem] mt-[5.9375rem]">
      <div className="aboutUsBg before:absolute before:inset-0 before:bg-gray before:rounded-[10px] before:sm:rounded-[1.25rem] before:md:rounded-[3.125rem] before:opacity-70 before:z-[1] bg-gray bg-blend-multiply absolute rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] inset-0 left-0 lg:left-[10.9375rem] bg-no-repeat bg-center bg-cover bg-[url('/images/about.jpg')]"></div>
        ...
        <div>
          <div className="aboutCapWrap w-full">
            <div className="aboutCap relative rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] overflow-hidden z-[1] lg:py-12 xl:pt-[4.6875rem] xl:pb-[4.375rem] p-5 md:p-10 lg:px-[3.5rem] xl:px-20">
              <div className="aboutCapBg bg-white opacity-90 opc8 absolute rounded-in sm:rounded-[1.25rem] md:rounded-[3.125rem] inset-0 bg-no-repeat bg-center bg-cover z-[-1]"></div>
              <h3 className="text-[#f6371c]2 font-light text-[1.5rem] md:text-[1.875rem] leading-tight font-Poppins">Hi,</h3>
              <h4 className="text-[#f6371c]2 font-light text-[1.325rem] md:text-[1.5rem] leading-normal font-Poppins">My name is <span className="text-[#f6371c] font-bold uppercase text-[1.5rem] md:text-[1.875rem]">Muhammd Owais</span>
              </h4>
              <ul className="grid grid-cols-1 gap-5 mt-6">
                <li className="grid grid-cols-3 gap-4 text-[1rem] md:text-[1.125rem]">
                  <strong className="text-desc3 uppercase font-bold font-Poppins col-span-1">Age:</strong>
                  <span className="text-desc2 font-semibold font-NunitoSans col-span-2">24</span>
                </li>
                <li className="grid grid-cols-3 gap-4 text-[1rem] md:text-[1.125rem]">
                  <strong className="text-desc3 uppercase font-bold font-Poppins col-span-1">Phone:</strong>
                  <span className="text-desc2 font-semibold font-NunitoSans col-span-2">
                    <a className="text-desc2 font-semibold font-NunitoSans hover:text-[#f6371c]" href="tel:+923323745184" title="">+92 3323745184</a>
                  </span>
                </li>
                <li className="grid grid-cols-3 gap-4 text-[1rem] md:text-[1.125rem]">
                  <strong className="text-desc3 uppercase font-bold font-Poppins col-span-1">Email:</strong>
                  <span className="text-desc2 font-semibold font-NunitoSans col-span-2">
                    <a className="text-desc2 font-semibold font-NunitoSans hover:text-[#f6371c]" href="mailto:mohammadowaisfaiz@gmail.com" title="">mohammadowaisfaiz@gmail.com</a>
                  </span>
                </li>
                <li className="grid grid-cols-3 gap-4 text-[1rem] md:text-[1.125rem]">
                  <strong className="text-desc3 uppercase font-bold font-Poppins col-span-1">Address:</strong>
                  <span className="text-desc2 font-semibold font-NunitoSans col-span-2">Karachi, Sindh, Pakistan.</span>
                </li>
                <li className="grid grid-cols-3 gap-4 text-[1rem] md:text-[1.125rem]">
                  <strong className="text-desc3 uppercase font-bold font-Poppins col-span-1">Freelancer:</strong>
                  <span className="text-desc2 font-semibold font-NunitoSans col-span-2 uppercase flex items-center">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 8 16" className="fill-[#f6371c]" height="1.5rem" width="1.5rem" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" d="M0 8c0-2.2 1.8-4 4-4s4 1.8 4 4-1.8 4-4 4-4-1.8-4-4z"></path>
                    </svg>Available </span>
                </li>
              </ul>
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 425 165" className="fill-[#f6371c] h-[4.5rem] mt-[2.375rem]">
                <g>
